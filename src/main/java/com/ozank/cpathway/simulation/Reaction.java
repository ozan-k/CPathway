...
public class Reaction {
    ...
    public Reaction(String id, double rate, Map<String,Integer> reactants, Map<String,Integer> products) {
        this.id = id;
        this.rate = rate;
    ...
    public Reaction(double rate, Map<String,Integer> reactants, Map<String,Integer> products) {
